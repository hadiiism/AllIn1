...
while true; do
    ...
    echo -e "${BLUE}|${YELLOW} 3.${NC} Install X-UI Panel${NC}                            ${BLUE}|${NC}"
    echo -e "${BLUE}|${YELLOW} 4.${NC} Install and Config SSL${NC}                        ${BLUE}|${NC}"
    echo -e "${BLUE}|${YELLOW} 5.${NC} Cisco AnyConnect${NC}                              ${BLUE}|${NC}"
    echo -e "${BLUE}|${YELLOW} 6.${NC} Change SSH Port${NC}                               ${BLUE}|${NC}"
    echo -e "${BLUE}|${YELLOW} 7.${NC} Fix DNS & Google Recapcha${NC}                     ${BLUE}|${NC}"
    echo -e "${BLUE}|${YELLOW} 8.${NC} Install Mtproto Proxy${NC}                         ${BLUE}|${NC}"
    echo -e "${BLUE}|${YELLOW} 9.${NC} Add User (for SSH)${NC}                            ${BLUE}|${NC}"
    echo -e "${BLUE}|${YELLOW}10.${NC} Install OpenVPN${NC}                               ${BLUE}|${NC}"
    echo -e "${BLUE}|${YELLOW}11.${NC} Install and Config WordPress${NC}                  ${BLUE}|${NC}"
    echo -e "${BLUE}|${YELLOW}12.${NC} Speedtest${NC}                                     ${BLUE}|${NC}"
    echo -e "${BLUE}|${YELLOW}13.${NC} Tunnel two server using IPtables${NC}              ${BLUE}|${NC}"
    echo -e "${BLUE}|${YELLOW}14.${NC} Cloudflare white IP Scanner${NC}                   ${BLUE}|${NC}"
    echo -e "${BLUE}|${YELLOW}15.${NC} Reverse Proxy (UNDER development)${NC}             ${BLUE}|${NC}"
    echo -e "${BLUE}|${YELLOW}16.${NC} Setup WireGaurd${NC}                               ${BLUE}|${NC}"
    echo -e "${BLUE}|${YELLOW}17.${NC} Setup Outline${NC}                                 ${BLUE}|${NC}"
    echo -e "${BLUE}|${YELLOW}18.${NC} Server Backup${NC}                                 ${BLUE}|${NC}"
